                      ...
                      <form action="#" method="post" class="main-input">
                        ...
                        <div class="row">
                          <div class="form-group col-md-6">
                            ...
                            <input type="text" name="nom_parent" id="nom_parent" required="" maxlength="100">
                          </div>
                          <div class="form-group col-md-6">
                            <label for="lien_parental_id">Lien parental <i class="text-danger">*</i></label>
                            <select name="lien_parental_id" id="lien_parental_id" class="form-control" required>
                              <option value=""></option>
                              <option value="Masculin">Enfant</option>
                              <option value="Féminin">Tuteur</option>
                              <option value="Féminin">Tutrice</option>
