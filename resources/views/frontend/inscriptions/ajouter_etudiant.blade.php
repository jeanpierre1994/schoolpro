...
<section class="w3l-contact-breadcrum">
    <div class="breadcrum-bg py-sm-5 py-4">
      <div class="container py-lg-3">
        ...
        <p><a href="{{route('profil')}}">Profil</a> &nbsp; / &nbsp; Inscription étudiant</p>
      </div>
    </div>
  </section>
  <!-- - - - -->
  <section class="w3l-contacts-12" id="contact">
      <div class="contact-top pt-1">
          <div class="container py-md-3">              
              <div class="row justify-content-md-center cont-main-top well">
                {{--<h3 class="mb-5">Formulaire d'inscription étudiants</h3>--}}
                   <!-- inscription étudiant form -->
                   <div class="contacts12-main col-offset-1 col-lg-12 mt-lg-0 mt-5"> 
                    ...
                    <div class="row justify-content-center mt-0">
                        <div class="col-12 col-sm-12 col-md-12 col-lg-12 text-center p-0 mt-3 mb-2">
                            <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                                <h2><strong>Formulaire d'inscription étudiants</strong></h2>
                                <div class="row">
                                    <div class="col-md-12 mx-0">
                                        <form id="msform" action="{{route('save-etudiant')}}" method="post" class="main-input">
                                            @csrf
                                            ...
                                            <fieldset>
                                                <div class="form-card">
                                                    ...
                                                    <label for="">Nom parent <i class="text-danger"></i></label>
                                                    <input type="text" readonly class="form-control" name="nom_parent" value="DOSSOU" placeholder=""/>
                                                    <label for="">Prénoms parent <i class="text-danger"></i></label>
                                                    <input type="text" readonly class="form-control" name="prenom_parent" value="Jeannette" placeholder="Prénoms parent"/> 
                                                    <label for="">Lien parental <i class="text-danger"></i></label>
