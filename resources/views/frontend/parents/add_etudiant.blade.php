    ...
    <div class="container py-1">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          @endif
      <form action="{{route('parent.etudiant-store')}}" method="POST" class="row g-3 needs-validation" novalidate enctype="multipart/form-data"> 
        @csrf 
        <div class="form-row">
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      <span class="input-group-text" id="inputGroupPrepend"><i class="fas fa-user-alt fa-fw me-3"></i></span>
                      <input type="text" class="form-control" id="nom" value="" required aria-describedby="inputGroupPrepend"
              ...
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="prenoms" required aria-describedby="inputGroupPrepend"
                          required name="prenoms" minlength="2" maxlength="150" value=""/>
          ...
          <div class="form-row">
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      <span class="input-group-text" id="inputGroupPrepend"><i class="fas fa-user-alt fa-fw me-3"></i></span>
                      <input type="text" class="form-control" id="nom_jeune_fille" value="" aria-describedby="inputGroupPrepend"
              ...
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="date" class="form-control" id="ddn" required aria-describedby="inputGroupPrepend"
                           name="ddn" max="{{date("Y-m-d")}}" value="" required/>
          ...
          <div class="form-row">
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="lieu_naissance" value="" required aria-describedby="inputGroupPrepend"
              ...
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="adresse" required aria-describedby="inputGroupPrepend"
                           name="adresse" minlength="2" maxlength="150" value=""/>
          ...
          <div class="form-row">
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="telephone" required aria-describedby="inputGroupPrepend"
                          required name="telephone" maxlength="20" value=""/>
              ...
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="email" value="" required aria-describedby="inputGroupPrepend"
          ...
          <div class="form-row"> 
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="site_web" aria-describedby="inputGroupPrepend"
                           name="site_web" maxlength="150" value=""/>
              ...
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="lien_linkedin" value="" aria-describedby="inputGroupPrepend"
          ...
          <div class="form-row"> 
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="lien_facebook" aria-describedby="inputGroupPrepend"
                           name="lien_facebook" maxlength="150" value=""/>
              ...
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      ...
                      <input type="text" class="form-control" id="lien_github" value="" aria-describedby="inputGroupPrepend"
          ...
          <div class="form-row">
              <div class="col-md-6 mb-2">
                  <div class="input-group form-outline">
                      <span class="input-group-text" id="inputGroupPrepend"><i class="fas fa-key fa-fw me-3"></i></span>
                      ...
                      <label for="password" class="form-label">Mot de passe <i class="text-danger">*</i></label>
                      <!--<div class="invalid-feedback">Champ obligatoire.</div>-->
                  </div>
              </div>
                <div class="col-md-6 mb-2">
                    <div class="input-group form-outline">
                        ...
                        <label for="confirm-password" class="form-label">Confirmation <i class="text-danger">*</i></label> 
                        <div class="invalid-feedback">Champ obligatoire.</div>
                    </div>
