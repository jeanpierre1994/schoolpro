    ...
    <section class="notes" style="padding: 0px;">
        ...
        <div class="data-table">
            ...
            <table style="font-family: 'Poppins'; padding:0px;">
                ...
                <tr style="padding:0px;line-height:0px;text-align:left">
                    <td>MARK /(20):</td>
        ...
        <section class="notes">
            ...
            <table style="font-family: 'Poppins';padding:0px;">
                ...
                @if ($notesSectionFrench)
                    ...
                    <tr style="padding:0px;line-height:0px;text-align:left">
                        <td style="text-align:left">MOYENNE GENERALE (/20):</td>
...
<div style="display: flex; justify-content:space-between;">
    <div></div>
    <table style="width: 100%; border:none; background: transparent; ">
        <tr style="background: transparent;line-height:0px; margin-top:0px;margin-bottom:0px;">
            <td style="width: 30%; border:none; margin-right: 0; rowspan=4";align=right;>
                <img src="nice/assets/img/badgeBritish.png" alt="badge" class="img-responsive" width="auto" height="100px" align=right/>
                    

            </td>
            
            
            <td style="border: none; margin-left: 0; margin-top:0;margin-bottom:0px; padding-left: 0">
                    <p style="font-family: montserrat; font-size: 18px;margin-top:0px;margin-bottom:2px">
                        <i>The Principal</i>
                    </p>
                    <img src="frontpage/assets/images/signature_directrice.jpg" alt="badge" class="img-responsive" width="auto" height="50"/>
                    <p style="font-family: Poppins; font-size: 18px; font-weight: bold; margin-top:15px;margin-bottom:2;">Charlotte Frédérique K. de SOUZA</p>
                
                <div style="width: 300px; height: 2px; background-color: #6d4c41; margin-left: -2px; margin-bottom:0;"></div>
                <p style="margin-left: 0px;margin-top:15px;margin-bottom:0px">
                    <i>
            ...
            <td style="bgcolor=0x230; border:none; margin-right: 0; margin-top:0px;margin-bottom:0px;"></td>
        </tr>
        
        <tr style="background: transparent;line-height:0px; margin-top:0px;margin-bottom:0px;">
            <td style=" border:none; margin-right: 0; margin-top:0px;margin-bottom:0px;"></td>
            <td style=" border:none; margin-right: 0; margin-top:0px;margin-bottom:0px;">
                <!--img src="frontpage/assets/images/signature_directrice.jpg" alt="badge" class="img-responsive" width="auto" height="50"-->

            </td>
            <td style="background:0; border:none; margin-right: 0; margin-top:0px;margin-bottom:0px;"></td>
        </tr>
        
        <tr style="background: transparent;line-height:0px; margin-top:0;margin-bottom:0px;">
            <td style="border:none; margin-right: 0; margin-top:0px;margin-bottom:0px;"></td>
            <td style="border: none; margin-left: 0; margin-top:0;margin-bottom:0px; padding-left: 0; colspan=2">
                    <!--p style="font-family: montserrat; font-size: 15px;margin-top:0px;margin-bottom:15px"-->
                        <!--i>The Principal</i-->
                    <!--/p-->
                <!--p style="font-family: Poppins; font-size: 18px; font-weight: bold; margin-top:0px;margin-bottom:2;"-->
        ...
        <tr style="background: transparent;margin-top:0px;margin-bottom:0px;">
            <td style="width: 30%; border:none; margin-right: 0; margin-top:0px;margin-bottom:0px;"></td>
            <td style="width: 30%; border:none; margin-right: 0; margin-top:0px;margin-bottom:0px;">
