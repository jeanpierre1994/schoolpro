            ...
            <tr style="background: transparent">
                ...
                <td style="text-align: center; font-size:130%; width:40%; border:none; ">
                    ...
                    <p style="font-family: 'Poppins'; font-weight: bold; font-size: 17px; margin-top: 0 ">
                        fbritishacademy@gmail.com &nbsp;&nbsp;&nbsp;&nbsp; <span
                                style="padding: 5px; background-color:rgb(204, 230, 230);">www.brif.one</span></p>
...
<main>
    ...
    <section class="notes">
        ...
        <table style="font-family: 'Poppins'; min-width: 100%; border:none; background: transparent ">
            <tr style="border: none; background-color: transparent">
                <td style="border: none">
                    <table style="max-width: 100px; border:none; background: transparent">
                        <thead>
                        <tr>
                            <th>MATIERES</th>
                            <th>NOTES /20</th>
                        ...
                        @if ($notesSectionFrench)
                            ...
                            <tr>
                                ...
                                <td colspan="6" style="text-align: left"><b>{{round($somme_moyenne/$somme_coef,2)}} </b>
                                </td>
                            </tr>
                        @endif
                ...
                <td style="border: none; background-color: transparent">
                    <div style="background-color:rgb(204, 230, 230); width: 250px ">
                        <p><i style="font-family: Poppins; color: red">Total des Coefficients</i></p>
                        <p style="color: red; font-weight: bold; font-size: 20px">{{ $somme_coef }}</p>
                        <p style="font-weight: bold; font-size: 20px;">Moyenne Trimestrielle </p>
                        <p style="font-weight: bold; font-size: 20px;">{{$synt_bulletin->moyenne}}</p>
                        <p style="font-weight: bolder; font-size: 20px;">RANG Trismestriel</p>
                        <p style="font-weight: bolder; font-size: 20px;">
                            @if($synt_bulletin->rang == 1)
                                {{ $synt_bulletin->rang . 'er ' }}
                            @else
                                {{ $synt_bulletin->rang .'ème '}}
                            @endif
                            sur {{$liste_etudiants->count()}}
                        </p>
                    </div>
                </td>
            </tr>
    ...
    <table style="width: 100%; border:none; background: transparent; ">
        <tr style="background: transparent;">
            <td style="width: 30%; border:none; margin-right: 0; ">
                <img src="nice/assets/img/badgeBritish.png" alt="badge" class="img-responsive" width="auto"
                     height="50px"
                     style="width: auto; height:150px;">
