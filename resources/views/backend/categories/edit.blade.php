...
<!-- title -->
@section('title') Modification Catégorie|| {{env('APP_NAME')}} @endsection
...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('categories.index')}}" style="text-decoration: none;">Catégories</a> </li>
...
<section class="section">
    ...
    <div class="card">
        ...
        <h5 class="card-title">Modification</h5>
          ...
          @endif
          <form action="{{ route('categories.update',$genre->id) }}" method="post">
            @csrf
            @method("put")
            <div class="row mb-3">
