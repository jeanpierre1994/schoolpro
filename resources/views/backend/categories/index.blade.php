    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Liste des catégories <a href="{{ route('categories.create') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                              <div class="d-flex justify-content-evenly">
                                                @if ($item->getStatut->libelle == 'ACTIF')
                                                    <a href="{{ route('admin.update-parametre', [$item->id, 'categories', 'desactivation']) }}"
                                                ...
                                                @else
                                                    <a href="{{ route('admin.update-parametre', [$item->id, 'categories', 'activation']) }}"
                                                ...
                                                @endif
                                                <a href="{{ route('categories.edit', $item->id) }}" title="Modifier"><button
