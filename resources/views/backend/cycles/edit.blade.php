...
<!-- title -->
@section('title') Modification Cycle|| {{env('APP_NAME')}} @endsection
        ...
        <h5 class="card-title">Modification</h5>
          ...
          <form action="{{ route('cycles.update',$cycle->id) }}" method="post">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" value="{{$cycle->libelle}}" required name="libelle" id="libelle" minlength="3" maxlength="50">
              </div>
            </div>  
            <div class="row mb-3">
