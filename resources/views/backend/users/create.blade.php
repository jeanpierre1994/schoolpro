...
<!-- title -->
@section('title') Enregistrement Utilisateur || {{env("APP_NAME")}} @endsection
...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('users.index')}}" style="text-decoration: none;">Utilisateur</a> </li>
