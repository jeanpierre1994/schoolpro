            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('grille_tarifaires.store') }}" method="post">
                            @csrf
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Libellé <i
                                        class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" required name="libelle" id="libelle"
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Libellé Secondaire <i
                                        class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" required name="libelle_secondaire"
