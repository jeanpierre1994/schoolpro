...
<!-- title -->
@section('title')
    Enregistrement de Grille| {{ env('APP_NAME') }}
@endsection
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('famille_rubriques.index') }}"
                        style="text-decoration: none;">Grille Tarifaires</a> </li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('grille_tarifaires.update', $grilleTarifaire->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" value="{{ old('libelle', $grilleTarifaire->libelle) }}" class="form-control" required name="libelle" id="libelle"
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-2 col-form-label">Libellé Secondaire <i
                                        class="text-danger">*</i></label>
                                <div class="col-sm-10">
                                    <input type="text" value="{{ old('libelle_secondaire', $grilleTarifaire->libelle_secondaire) }}" class="form-control" required name="libelle_secondaire"
