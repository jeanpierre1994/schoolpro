...
<!-- title -->
@section('title')
    Enregistrement de Ligne Tarifaire|| {{ env('APP_NAME') }}
@endsection
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('famille_rubriques.index') }}"
                        style="text-decoration: none;">Details </a> </li>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('ligne_tarifaires.store') }}" method="post">
                            @csrf
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="rubrique_id" id="gp_id" required>
                                        ...
                                        @foreach ($rubriques as $rubrique)
                                            <option value="{{ $rubrique->id }}">{{ $rubrique->libelle }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="grille_tarifaire_id" id="gp_id" required>
                                        ...
                                        @foreach ($grilleTarifaires as $grilleTarifaire)
                                            <option value="{{ $grilleTarifaire->id }}">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="form-check form-switch">
                                        <input class="form-check-input ml-0" type="checkbox" id="flexSwitchCheckChecked" name="is_required" checked>
                                    </div>
                                </div>
                            </div>
                            <div class="row mb-3">
