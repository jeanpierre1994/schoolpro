...
<!-- title -->
@section('title')
    Dossier rejeté || {{ env('APP_NAME') }}
@endsection

@section('fil-arial')
    <div class="pagetitle">
        <h1>Dossiers rejeté</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#" style="text-decoration: none;">Accueil</a></li>
                <li class="breadcrumb-item active">Dossiers rejeté </li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Liste des dossiers rejetés</h5>
                        <!-- Bordered Table -->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->getStatuttraitement->libelle == 'EN ATTENTE')
                                                    <span
                                                        class="badge badge-warning rounded-pill d-inline">{{ $item->getStatuttraitement->libelle }}</span>
                                                @else
                                                    <span
                                                        class="badge badge-danger rounded-pill d-inline">{{ $item->getStatuttraitement->libelle }}</span>
                                                @endif
                                            </td> 
                                        </tr>
                                    @endforeach
