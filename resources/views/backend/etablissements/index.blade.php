...
<!-- title -->
@section('title') Etablissements|| {{env('APP_NAME')}} @endsection
...
<div class="card">
    <div class="card-body">
      <h5 class="card-title">Liste des établissements <a href="{{route('etablissements.create')}}" title="Ajouter"><button style="font-size: 5px;" type="button" class="btn btn-sm btn-outline-primary"><i class="bi bi-plus-circle" aria-hidden="true" style="font-size: 10px;"></i></button></a></h5>
      <!-- Bordered Table -->
      ...
      <table class="table table-striped table-hover table-bordered data-tables">
        ...
        <tbody>
          ...
          <tr>
              ...
              <td>{{$item->adresse}}</td>
              <td>{{$item->statutjuridique_id ? $item->getStatutjuridique->libelle : ''}}</td>
              <td>{{$item->dirigeant}}</td>
              <td>{{$item->ifu}}</td>
                  ...
                  <div class="modal-dialog modal-md modal-dialog-centered">
                      <div class="modal-content text-center">
                          ...
                          <div class="modal-footer">
                                  ...
                                  <form action="{{ route('etablissements.destroy',$item->id) }}" method="post">
                                    @method("DELETE")
                                    @csrf
