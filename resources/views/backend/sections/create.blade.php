...
<!-- title -->
@section('title') Enregistrement Section|| {{env('APP_NAME')}} @endsection
...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('sections.index')}}" style="text-decoration: none;">Sections</a> </li>
