    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Liste des genres <a href="{{ route('genres.create') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                              <div class="d-flex justify-content-evenly">
                                                @if ($item->getStatut->libelle == 'ACTIF')
                                                    <a href="{{ route('admin.update-parametre', [$item->id, 'genres', 'desactivation']) }}"
                                                ...
                                                @else
                                                    <a href="{{ route('admin.update-parametre', [$item->id, 'genres', 'activation']) }}"
                                                ...
                                                @endif
                                                <a href="{{ route('genres.edit', $item->id) }}" title="Modifier"><button
                                                    ...
                                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                                        <div class="modal-content text-center">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('genres.destroy', $item->id) }}"
                                                                    method="post">
                                                                    @method('DELETE')
                                                                    @csrf
