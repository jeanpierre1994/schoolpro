...
<!-- title -->
@section('title') Permissions || {{env('APP_NAME')}} @endsection
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Liste des permissions <a href="{{route('permissions.create')}}" title="Ajouter"><button style="font-size: 5px;" type="button" class="btn btn-sm btn-outline-primary"><i class="bi bi-plus-circle" aria-hidden="true" style="font-size: 10px;"></i></button></a></h5>
                        <!-- Bordered Table -->
                                ...
                                @foreach ($permissions as $permission )
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a href="{{ route('permissions.edit',$permission->id    ) }}" title="Modifier"><button type="button" class="btn btn-sm btn-warning"><i class="bi bi-pencil-square" style="color: white" aria-hidden="true"></i></button></a>
                                            {{--<a href="{{ route('sites.show',$item->id) }}" title="Voir les détails du statut"><button type="button" class="btn btn-sm btn-secondary"><i class="bi bi-eye" style="color: white" aria-hidden="true"></i></button></a>--}}
                                            <a href="#" class="page-constructionv" data-bs-toggle="modal" data-bs-target="#myModal_{{ $permission->id  }}">
                                            ...
                                            <!-- The Modal -->
                                            <div class="modal text-center" id="myModal_{{ $permission->id   }}">
