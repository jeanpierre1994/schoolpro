...
<!-- title -->
@section('title') Enregistrement Filière|| {{env('APP_NAME')}} @endsection
...
<div class="pagetitle">
    ...
    <nav>
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{route('filieres.index')}}" style="text-decoration: none;">Filières</a> </li>
        ...
        <h5 class="card-title">Enregistrement</h5>
          ...
          <form action="{{ route('filieres.store') }}" method="post">
            ...
            <div class="row mb-3">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" required name="libelle_secondaire" id="libelle_secondaire" minlength="1" maxlength="100">
              </div>
            </div> 
            <div class="row mb-3">
