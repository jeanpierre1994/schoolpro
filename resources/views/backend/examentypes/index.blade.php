...
<!-- title -->
@section('title')
    Liste Examen Type || {{ env('APP_NAME') }}
@endsection
...
@section('fil-arial')
    <div class="pagetitle">
        ...
        <li class="breadcrumb-item"><a href="{{route('dashboard')}}" style="text-decoration: none;">Dashboard</a></li>
                ...
                <li class="breadcrumb-item active">Examen type </li>
            </ol>
        </nav>
    </div>
@endsection
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title">Liste des examens types <a href="{{ route('examentypes.create') }}"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                              <div class="d-flex justify-content-evenly">
                                                @if ($item->getStatut->libelle == 'ACTIF')
                                                    <a href="{{ route('admin.update-parametre', [$item->id, 'examentypes', 'desactivation']) }}"
                                                ...
                                                @else
                                                    <a href="{{ route('admin.update-parametre', [$item->id, 'examentypes', 'activation']) }}"
                                                ...
                                                @endif
                                                <a href="{{ route('examentypes.edit', $item->id) }}" title="Modifier"><button
                                                    ...
                                                    <div class="modal-dialog modal-md modal-dialog-centered">
                                                        <div class="modal-content text-center">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <form action="{{ route('examentypes.destroy', $item->id) }}"
                                                                    method="post">
                                                                    @method('DELETE')
                                                                    @csrf
